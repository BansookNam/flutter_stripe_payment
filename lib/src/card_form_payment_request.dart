class CardFormPaymentRequest {
  ...
  factory CardFormPaymentRequest.fromJson(Map<dynamic, dynamic> json) {
    return CardFormPaymentRequest(
      prefilledInformation: json['prefilledInformation'] != null ? PrefilledInformation.fromJson(json['prefilledInformation']) : null,
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.requiredBillingAddressFields != null) if (this.requiredBillingAddressFields != null) data['requiredBillingAddressFields'] = this.requiredBillingAddressFields;
