...
class SourceParams {
  ...
  SourceParams({this.amount, this.currency, @required this.returnURL, @required this.type, this.name, this.statementDescriptor, this.country, this.email, this.card});
